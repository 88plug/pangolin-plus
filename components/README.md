...
| **gerbil/** | [fosrl/gerbil](https://github.com/fosrl/gerbil) | **1.4.3** | Vendored baseline — mine next |
| **olm/** | [fosrl/olm](https://github.com/fosrl/olm) | **1.8.1** | Vendored baseline — mine next |
| **badger/** | [fosrl/badger](https://github.com/fosrl/badger) | **v1.5.0** | Vendored baseline — mine next |
