...
image_tag: v1.21.3-plus   # or 1.21.3-plus / latest
pull_images: true
```
...
# make plus-release-binaries VERSION=1.21.3-plus
...
| Var | Default |
|-----|---------|
| `pangolin_image` | `ghcr.io/88plug/pangolin-plus/pangolin:v1.21.3-plus` |
| `gerbil_image` | `ghcr.io/88plug/pangolin-plus/gerbil:v1.21.3-plus` |
