...
function ProxyResourceHttpForm({
    ...
    const form = useForm({
        ...
        defaultValues: {
            ...
            responseHeaders: resource.responseHeaders ?? null
        },
        mode: "onChange"
    });
                                            ...
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {t(
                                                        ...
                                                        {
                                                            fallback:
                                                                "Request headers sent to the downstream targets. One per line: Header-Name: value"
                                                        }
                                                    )}
                                                </FormDescription>
                                                <FormMessage />
                                            ...
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {t(
                                                        ...
                                                        {
                                                            fallback:
                                                                "Response headers sent back to the client. One per line: Header-Name: value"
                                                        }
                                                    )}
                                                </FormDescription>
                                                <FormMessage />
